...
# ╔═╡ f6c0002f-ec11-4284-ad82-d1523911175c
begin
...
# ╔═╡ d48c38b4-47f4-4728-9c08-b93c583b8d5c
# helper files
...
# ╔═╡ 499047b1-4783-47c0-8baa-1c061ba6973d
# using Pluto
# Pluto.run()

# ╔═╡ b057c1ba-7771-4ea6-b3be-44283e8fdb3a
## Problem 1
...
# ╔═╡ 8f325f28-9b6b-423f-ae4f-76877857d993
begin
	## earth-moon
	# characteristic mass
	m_star = mass_earth + mass_moon
	mu_earthmoon = mass_moon / m_star
	M2_earthmoon_nondim = mu_earthmoon
	M1_earthmoon_nondim = 1 - mu_earthmoon
	println("mass ratio (earth-moon): ", mu_earthmoon)
	println("characteristic mass (earth-moon): ", m_star)

	# characteristic length
	r1_earth2bary = 4670 # km
	r2_moon2bary = sma_moon_wrtearth - r1_earth2bary
	l_star = r1_earth2bary + r2_moon2bary
	println("characteristic length (earth-moon): ", l_star)

	# characteristic time
	t_star = (l_star^3 / (gm_earth + gm_moon))^0.5
	println("characteristic time (earth-moon): ", t_star)

	## sun-earth
	# characteristic mass
	m_star = mass_sun + mass_earth
	mu_sunearth = mass_earth / m_star
	M2_sunearth_nondim = mu_sunearth
	M1_sunearth_nondim = 1 - mu_sunearth
	println("mass ratio (sun-earth): ", mu_sunearth)
	println("characteristic mass (sun-earth): ", m_star)

	# characteristic length
	l_star = sma_earth_wrtsun
	println("characteristic length (sun-earth): ", l_star)

	# characteristic time
	t_star = (l_star^3 / (gm_sun + gm_earth))^0.5
	println("characteristic time (sun-earth): ", t_star)

	
end

# ╔═╡ ba256065-4e66-4a29-95d5-ed866d377bb4


# ╔═╡ 0e00af64-2ef6-4c03-bfa6-7d1b52a38ffc
## Problem 2
...
# ╔═╡ 9dd9219c-f1f2-4137-8ba1-138e6339a0e6
...
# ╔═╡ 799e901a-c513-4083-83ce-9e0756abb036
begin
	# initial condition 1
	...
	sol = solve(prob, RK4(), dt=dt, dense=false)
	# println(sol.t)
	# println(sol[2,:])
	...
	# plot(sol.t, sol')
	plot(sol,idxs=(1,2,3), title="x_bar = $x_bar, dt=$dt units")
	# plot(x=0, y=0, z=0, title="earth = $x_bar, dt=$dt units")
end

# ╔═╡ 64e958d2-bfa5-40f8-9ac8-80a2de1c6efa
begin
	# initial condition 2
	...
	plot(sol2,idxs=(1,2,3))
end

# ╔═╡ a598cae7-b42c-4774-b304-5bb699f20565
# ╠═╡ disabled = true
#=╠═╡
begin
	# initial condition 3
...
# ╔═╡ 863379c7-d1c5-446a-83cd-f96a71d46d5b
# ╠═╡ disabled = true
#=╠═╡
begin
	# initial condition 4
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "c18468145af1a3a93b880b35dea5107782b14606"
...
git-tree-sha1 = "adb5564e0e1451c95c7dffaae416c8383db080e6"
...
git-tree-sha1 = "5adfcbca6623680cf11b05bf932b4f36a93c0d99"
